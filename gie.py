...
import GYEVHA
from GYEVHA.lib.curve.ttypes import *
from datetime import datetime
import time,random,sys,json,codecs,threading,glob,re,os,subprocess

cl = GYEVHA.LINE()
cl.login(token="EsdkhfqXWXqw48vsTWne.ee6vQU/1ppqr93nt9QLUZG.RNCuGBU4r7iOiUfP4mnFMRFHdx2c1TG18iyVH6fwnG0=")
cl.loginResult()

ki = GYEVHA.LINE()
ki.login(token="EsBYJ2gfeMkoh4QetiV8.LbKSlO2RNNtmSLzP4n8FEa.cQ5XLV30vmjIwGpp5EOsYIdqixQRJjnKwaf2zLo6l54=")
ki.loginResult()

ki2 = GYEVHA.LINE()
ki2.login(token="Es9GPDQCkldujRljQq74.qrOEJZSIvR2MdAkeGXx+ba.tCIwRTallqqt3wdypftKeGNZ6ibru9TgmgpUK5Pna5E=")
ki2.loginResult()

print "login success Gye"
reload(sys)
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""тerima Kasih Sudah Menambahkan Aku Jadi Teman Bye\n🔛GYEVHA BOTS🔛""",
    "lang":"JP",
...
def bot(op):
            ...
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                pass
              	...
              	try:
                	cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Tolong Ya Jangan Buka Buka Qr Nanti Ada Kikil")
                	cl.kickoutFromGroup(op.param1,[op.param2])
                	X = cl.getGroup(op.param1)
                	X.preventJoinByTicket = True
                	cl.updateGroup(X)
                	cl.sendText(op.param1,cl.getContact(op.param2).displayName + "\n" + "Kami Masukan Anda Ke Dalam Daptar Buronan")
            ...
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  cl.sendText(op.param1, "Mau Ngundang Siapa Kak...?\nJangan Sembarangan Undang Yah\nMaaf Aku Kick")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                except:
                  random.choice(KAC).cancelGroupInvitation(op.param1, gMembMids)
                  random.choice(KAC).sendText(op.param1, "Ijin Dulu Kak Kalau Mau Invit\nMaaf Aku Kick")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
          ...
          if wait["Protectjoin"] == True:
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                try:
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                  cl.sendText(op.param1, "Protect Join nya Kk\nModarin  dulu kalo mau Ada yang Gabung\n\n🔜Joinn on/off")
                except:
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                  cl.sendText(op.param1, "Protect Join nya Kk\nModarin  dulu kalo mau Ada yang Gabung\n\n🔜Joinn on/off")
        #------Joined User Kick start------#
          ...
          if wait["Protectcancel"] == True:
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                random.choice(KAC).sendText(op.param1, "Resiko Buka Wr Sembarangan Seperti Ink Kick")
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])   
    ...
    #--------------- SC Add Admin ---------
              ...
              if targets == []:
                ...
                for target in targets:
                  try:
                    admin.append(target)
                    cl.sendText(msg.to,"🔜 Admin Berhasil Di Tambahkan")
                  except:
                    pass
              ...
              if admin == []:
                  ...
                  cl.sendText(msg.to,"Tunggu Lowding Signal Mu Lelet...")
                  mc = "╔═══════════════════╗\n     🔛 GYEVHA BOTS 🔛\n╚═══════════════════╝\n"
                  for mi_d in admin:
    ...
    #-----------------=Selesai=------------------
            ...
            ##if msg.from_ in admin:
              ...
              ##if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"🔜 QR Terbuka")
                    else:
                        cl.sendText(msg.to,"🔜 Lihat dulu Bos Dari Tadi\nQr Sudah Terbuka Boss")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can not be used outside the group")
                    else:
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Gye Buka qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"🔜 Sudah Di Buka Bos")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Gye2 buka qr"]:
                if msg.toType == 2:
                    X = ki2.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki2.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki2.sendText(msg.to,"🔜 Sudah Di buka")
                    else:
                        ki2.sendText(msg.to,"🔜 Berhasil Di Buka ")
                else:
                    if wait["lang"] == "JP":
		...
		for ticket_id in n_links:
            ...
            elif msg.text in ["Me","Wkwk","Wk","wkwkwk","wkwk","wk"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
            ...
            elif msg.text in ["Gye rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Gye1 rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile = ki.getProfile()
                    profile.displayName = string
                    ki.updateProfile(profile)
                    ki.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Gye2 rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Gye2 rename ","")
                if len(string.decode('utf-8')) <= 20:
...
#-------------------- Protect Mode ------------
                ...
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"🔜 Kick Yg Join ")
                    else:
                ...
                if wait["Protectgr"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"🔜 done")
#----------------------------------------------
            elif msg.text in ["Pro on","Protect on"]:
              #if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Pro off","Protect off"]:
              #if msg.from_ in admin:
                if wait["Protectjoin"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"🔜kick Joined Group Off")
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"🔜done")
            elif msg.text in ["Cancel on","Cn o"]:
              #if msg.from_ in admin:
                if wait["Protectcancl"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"🔜done")
            elif msg.text in ["Cancel off","Cc o"]:
              #if msg.from_ in admin:
                if wait["Protectcancl"] == False:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"🔜done")
            elif msg.text in ["Invite on","If o"]:
              #if msg.from_ in admin:
                if wait["Protectcancel"] == True:
                    if wait["lang"] == "JP":
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Masuk","Join all","In"]:
    ...
    #-------------Tag All Test------------------------#
    #-------------------------------------------------#
            elif msg.text in ["Bot Like", "BL"]:
              #if msg.from_ in admin:
                print "[Command]Like executed"
                cl.sendText(msg.to,"🔜 Sabar Bos Pasti Kami Like")
                try:
                  likePost()
                except:
                  pass
                
            elif msg.text in ["Like Kawan", "Lt"]:
              #if msg.from_ in admin:
                print "[Command]Like executed"
                cl.sendText(msg.to,"🔜Desah Dulu Bos Nanti Kami Like")
                try:
                  autolike()
                except:
                  pass
        #----------------Fungsi Banned Kick Target Start-----------------------#
            elif msg.text in ["Kill","Bantai"]:
              #if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        random.choice(KAC).sendText(msg.to,"🔜Hus Hus Sana Out")
                        random.choice(KAC).sendText(msg.to,"🔜Jangan Masuk Lagi Ya Muak Aku")
                        return
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Ready op","Ratakan")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    cl.sendText(msg.to,"Hello Kk")
                    cl.sendText(msg.to,"Gyevha Team Mau Bersih² Group Sampah Nih")
                    cl.sendText(msg.to,"Karna Ini Group Sampah Jadi Mau Di Bersihin Dulu Yah\n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u104e95aaefb53cf411f77353f6a96ece'}
                    cl.sendMessage(msg)
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot Out","Pulang"]:
              #if msg.from_ in admin:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Cek","Absen dulu","Respon"]:
              #if msg.from_ in admin:
                cl.sendText(msg.to,"🔜Saya")
                ki.sendText(msg.to,"🔜Asisit 2")
                ki2.sendText(msg.to,"🔜Asist 3")
      ...
      #-------------Fungsi Bannlist Start------------------#          
              ...
              #if msg.from_ in admin:
                if wait["blacklist"] == {}:
                    random.choice(KAC).sendText(msg.to,"🔛Tidak Ada Daptar Bangsat 🔛")
                else:
                    random.choice(KAC).sendText(msg.to,"Blacklist user")
                    mc = ""
                    for mi_d in wait["blacklist"]:
                        mc += "Daptar Bangsat " +cl.getContact(mi_d).displayName + "\n"
                    cl.sendText(msg.to,mc)
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"🔛GYEVHA BOTS🔛")
                    print "Like"
                except:
                    pass
            else:
